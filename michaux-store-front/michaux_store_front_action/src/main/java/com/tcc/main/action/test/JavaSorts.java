...
/**
 * @Description Java七种排序方法
 * @Author Tu chengcheng
 * @Company Michaux Store Copyright
 * @Date 2018年11月19日 下午5:39:45
 */
public class JavaSorts {
	
	private static int[] array = new int[]{11, 31, 12, 5, 34, 30, 26, 38, 36, 18};

	public static void main(String[] args) {
		System.out.println("插入排序:" + array2String(sortInsert(array)));
		System.out.println("选择排序:" + array2String(sortSelect(array)));
		System.out.println("冒泡排序:" + array2String(sortBubble(array)));
		System.out.println("快速排序:" + array2String(sortQuick(array)));
		System.out.println("归并排序:" + array2String(sortMerge(array)));
		System.out.println("希尔排序:" + array2String(sortShell(array)));
		System.out.println("堆排序 : " + array2String(sortHeap(array)));
